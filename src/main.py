...
def enterinfo():
    ...
    txtpayslip.insert(END, "CNIC Number :\t\t" + CNICNumber.get() + "\n\n")
...
lblEmployer = Label(fla, text="Employer", font=('arial', 16, 'bold'), bd=20, fg="red", bg="powder blue").grid(row=1,
                                                                                                              column=0)
lblCNICNumber = Label(fla, text="CNIC Number", font=('arial', 16, 'bold'), bd=20, fg="red", bg="powder blue").grid(row=1,
                                                                                                               column=2)
...
etxnin = Entry(fla, textvariable=CNICNumber, font=('arial', 16, 'bold'), bd=16, width=22, justify='left')
